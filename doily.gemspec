...
Gem::Specification.new do |s|
  ...
  s.files = ["Rakefile", "README.rdoc", "features/chef_nodes.feature", "features/chef_openid_registrations.feature", "features/chef_roles.feature", "features/steps", "features/steps/chef.rb", "features/support", "features/support/environment.rb", "features/support/helpers.rb", "lib/doily", "lib/doily/errors.rb", "lib/doily/parser.rb", "lib/doily/parser.y", "lib/doily/types", "lib/doily/types/access.rb", "lib/doily/types/assignment.rb", "lib/doily/types/binding.rb", "lib/doily/types/block.rb", "lib/doily/types/call.rb", "lib/doily/types/conditional.rb", "lib/doily/types/declaration.rb", "lib/doily/types/function.rb", "lib/doily/types/literal.rb", "lib/doily/types/loop.rb", "lib/doily/types/object.rb", "lib/doily/types/reference.rb", "lib/doily/types.rb", "lib/doily.rb", "test/doily_test.rb", "test/test_helper.rb"]
  s.rdoc_options = ["--main", "README.rdoc", "--title", "doily-0.1.0", "--inline-source", "--line-numbers", "--all"]
  s.require_paths = ["lib"]
